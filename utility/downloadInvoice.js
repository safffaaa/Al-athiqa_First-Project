  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .fontSize(20)
        // .fontSize(4)
        .text("Al-athiqa ", 200, 65, { align: "right" })        
        .moveDown();
        ...
        .text("Antique collections", 200, 85, { align: "right" })
        .text("Calicut, Kerala ", 200, 100, { align: "right" })
        .moveDown();
      ...
      doc
        ...
        .strokeColor("#ccc")
        .stroke()
        .text(`Custom User ID: ${order.customUserId}`, 50, 200)
